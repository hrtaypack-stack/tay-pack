...
export const Route = createFileRoute("/_app/employee/")({
  ...
  head: () => ({
    meta: [
      { title: "Employee Dashboard — Leave Management System" },
      {
        name: "description",
        content:
          "View your personal leave balance, recent time-off requests, and pending approvals in the employee dashboard.",
      },
      { property: "og:title", content: "Employee Dashboard — Leave Management System" },
      {
        property: "og:description",
        content:
          "View your personal leave balance, recent time-off requests, and pending approvals in the employee dashboard.",
      },
      { property: "og:url", content: "https://tay-pack.lovable.app/employee" },
      { name: "robots", content: "noindex" },
    ],
    links: [{ rel: "canonical", href: "https://tay-pack.lovable.app/employee" }],
  }),
});
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">
          Employee Dashboard — Welcome back, {profile?.fullName.split(" ")[0]}
        </h1>
